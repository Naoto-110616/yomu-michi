...
const DISTANCE: Record<RelationType, number> = {
  member: 48, bond: 66, follow: 1500, overlap: 1100, next: 34, pre: 60, alt: 84, counter: 98,
}
/** バネの強さ。別視点は弱くして「うっすら引き合う」程度に */
const STRENGTH: Record<RelationType, number> = {
  member: 0.5, bond: 0.18, follow: 0.03, overlap: 0.008, next: 0.45, pre: 0.32, alt: 0.06, counter: 0.1,
}
